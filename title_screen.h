...
int title_screen_logic( SDL_Window* l_window, SDL_Renderer* l_renderer )
{
	...
	l_quitGame = fade_in_texture( "images/non_sprites/title_screen.png", l_window, l_renderer );
    	...
    	if( e.type == SDL_KEYDOWN )
		{
			switch( e.key.keysym.sym )
    		{
           		case SDLK_SPACE:
					...
					l_quitGame = fade_out_texture( "images/non_sprites/title_screen.png", l_window, l_renderer );
