...
int opening_logic( SDL_Window* l_window, SDL_Renderer* l_renderer )
{
	...
	l_quitGame = fade_in_texture( "images/non_sprites/empresa.png", l_window, l_renderer );
	...
	l_quitGame = fade_out_texture( "images/non_sprites/empresa.png", l_window, l_renderer );
	
	// Libera imagem carregada
	SDL_DestroyTexture( l_texture );
	l_texture = NULL;
	
	l_quitGame = fade_in_texture( "images/non_sprites/sdlcredits.png", l_window, l_renderer );
	...
	SDL_Delay( 1000 );
	SDL_RenderClear( l_renderer );
	l_quitGame = fade_out_texture( "images/non_sprites/sdlcredits.png", l_window, l_renderer );
